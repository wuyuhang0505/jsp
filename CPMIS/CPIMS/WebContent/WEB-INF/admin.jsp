...
<body>
	<div id="FrameTop" class="frame-top">
		<div class="topdata">
			<div id="SysIcon"></div>
			<h2 class="systitle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h2>
			<div class="siteinfo">
				<p>欢迎您，${currentEmployee.employeeName }</p>
				<div class="toprightmenu">
					 <a	href="/CPIMS/employee/logout">退出系统</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="frame-left">
		<ul class="leftmenu">
			<li><a class="dropmenu">人事系统</a>
				<ul class="submenu">
					<li><a target="mainFrame" href="/CPIMS/employee/toSave">添加员工</a></li>
					<li><a target="mainFrame" href="/CPIMS/employee/list">员工列表</a></li>
					<li><a target="mainFrame" href="/CPIMS/move/toSave">添加员工调动</a></li>
					<li><a target="mainFrame" href="/CPIMS/move/list">员工调动列表</a></li>
					<li><a target="mainFrame" href="/CPIMS/employ/toSave">招聘人员登记</a></li>
					<li><a target="mainFrame" href="/CPIMS/employ/list">招聘人员列表列表</a></li>
				</ul></li>
			<li><a class="dropmenu">机构管理</a>
				<ul class="submenu">
					<li><a target="mainFrame" href="/CPIMS/department/toSave">添加部门</a></li>
					<li><a target="mainFrame" href="/CPIMS/department/list">部门列表</a></li>
					<li><a target="mainFrame" href="/CPIMS/post/toSave">添加岗位</a></li>
					<li><a target="mainFrame" href="/CPIMS/post/list">岗位列表</a></li>
				</ul></li>
			...
			<li><a class="dropmenu">专家系统</a>
				<ul class="submenu">
					...
					<li><a target="mainFrame" href="/CPIMS/specialistapply/list">专家申请审批</a></li>
					<li><a target="mainFrame"
			...
			<li><a class="dropmenu">职称系统</a>
				<ul class="submenu">
					...
					<li><a target="mainFrame" href="/CPIMS/rankapply/list">提升职称审批</a></li>
