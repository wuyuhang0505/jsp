...
<body>
	<div class="maincontainer">
		...
		<div class="fmcontainer">
			<form action="/CPIMS/logBook/save" method="post">
				...
				<table class="inputtable" width="98%">
					<tr>
						...
						<input id="d12" value="" name="logDate" type="text"  readonly="readonly" />
					...
					<tr>
						...
						<td colspan="3"><textarea name="logContent" cols="60" rows="8"></textarea></td>
					</tr>
				</table>
