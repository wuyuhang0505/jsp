...
<body>
	<div class="maincontainer">
		...
		<div class="fmcontainer">
			<form action="/CPIMS/specialistapply/${empty specialistapply?"
				save":"edit"}" method="post">
				<input type="hidden" name="specialistApplyId"
					value="${specialistapply.specialistApplyId }"></input>
				...
				<table class="inputtable" width="98%">
					<!-- <tr>
						...
						<td><input type="text"  name="employeeName" type="text"
							value="${currentEmployee.employeeName }" /></td>
						<td type="hidden" class="leftlabel">职工编号：</td>
						<td><input name="employeeId" type="text"
							value="${currentEmployee.employeeId }" /></td>

					</tr> -->
					<tr>
						<td class="leftlabel">申请称号：</td>
						<td><input value="${specialistapply.applySpecialistName }"
							name="applySpecialistName" type="text" /></td>
						...
						<td><script language="javascript" type="text/javascript"
							...
							value="${specialistapply.applyTime}" /> <img
					...
					<tr>
						...
						<td colspan="3"><textarea name="applyReason" cols="60"
								rows="8">${specialistapply.applyReason}</textarea></td>
					</tr>
				</table>
